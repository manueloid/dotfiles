...
-- Destroy all notifications
	...
	-- Swapping clients
	awful.key({ modkey, "Shift" }, "r", function() awful.client.swap.bydirection("up") end,
		{ description = "swap with next client up", group = "client" }),
	awful.key({ modkey, "Shift" }, "h", function() awful.client.swap.bydirection("down") end,
		{ description = "swap with next client down", group = "client" }),
	awful.key({ modkey, "Shift" }, "t", function() awful.client.swap.bydirection("right") end,
	...
	awful.key({ modkey, }, "b", function() awful.spawn(browser) end,
		{ description = "open the default browser", group = "launcher" }),
	...
	awful.key({ modkey, "Control" }, "s", function() awful.tag.incmwfact(-0.05) end,
	...
	-- Screen brightness
	awful.key({ altkey }, "q", function() os.execute("light -A 10") end,
		{ description = "+10%", group = "hotkeys" }),
	awful.key({ altkey }, "a", function() os.execute("light -U 10") end,
		{ description = "-10%", group = "hotkeys" }),
...
clientkeys = mytable.join(
	...
	awful.key({ modkey, "Contrql" }, "space", awful.client.floating.toggle,
